 ...
 */
public class MessageStartFlagCaptureOnGameMapTest  {
    ...
    public void testExec() throws Exception {
        Message ms = new MessageStartFlagCaptureOnGameMap(from, to, userProfile);
        ms.exec(gameMap);
        verify(gameMap, times(1)).startFlagCapture(userProfile);
    }
}