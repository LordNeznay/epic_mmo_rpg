 ...
 */
public class MessageStartFlagCaptureTest {
    ...
    public void testExec() throws Exception {
        Message ms = new MessageStartFlagCapture(from, to, userProfile);
        ms.exec(mechanicService);
        verify(mechanicService, times(1)).startFlagCapture(userProfile);
    }
}