 ...
 */
public class MessageUseAbilityTest {
    ...
    public void testExec() throws Exception {
        Message ms = new MessageUseAbility(from, to, userProfile, abilityName);
        ms.exec(mechanicService);
        verify(mechanicService, times(1)).useAbility(userProfile, abilityName);
    }
}